...
// LIST is a shortcut for router.Handle("GET", path, handle). add by 邹航宇 用于描述list资源的语义
func (group *RouterGroup) LIST(relativePath string, handlers ...HandlerFunc) IRoutes {
	// absolutePath := group.calculateAbsolutePath(relativePath)
	return group.handle("GET", relativePath, handlers...)
}
