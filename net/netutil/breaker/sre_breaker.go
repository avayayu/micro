...
import (
	...
	"gogs.buffalo-robot.com/zouhy/micro/stat/metric"
)
...
func (b *sreBreaker) Allow() error {
	...
	fmt.Printf("breaker: request: %d, succee: %d, fail: %d", total, success, total-success)
	...
	fmt.Printf("breaker: drop ratio: %f, drop: %t", dr, drop)
