...
func Get(t *testing.T, uri string, router *http.Engine, codeExpect int) (int, []byte) {
	// 构造get请求
...
func PostForm(t *testing.T, uri string, param map[string]string, router *http.Engine, codeExpect int) (int, []byte) {
...
func PostJson(t *testing.T, uri string, param interface{}, router *http.Engine, codeExpect int) (int, []byte) {
	// 将参数转化为json比特流
